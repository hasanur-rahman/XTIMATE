...
double relBoundRatio, int r5, int r4, int r3, int r2, int r1)
{
	...
	else if(dataType==SZ_DOUBLE)
	{
		unsigned char *newByteData;
                ...
                printf("\t SZ_compress_args_double parameters:\n");
                printf("\t\t &newByteData is a char* address, data[0:5]=[%lf, %lf, %lf, %lf, %lf], r5=%d, r4=%d, r3=%d, r2=%d, r1=%d, outSize=%d, errorBoundMode=%d, absErrBound=%lf, relBoundRatio=%lf\n", *(double*)data,*((double*)data+1), *((double*)data+2), *((double*)data+3), *((double*)data+4), r5, r4, r3, r2, r1, outSize, errorBoundMode, absErrBound, relBoundRatio);
...
{
        printf("\t SZ_compress_args parameters:\n");
        printf("\t\t dataType=%d, data[0:5]=[%lf, %lf, %lf, %lf, %lf], outSize=%d, errorBoundMode=%d, absErrBound=%lf, relBoundRatio=%lf, r5=%d, r4=%d, r3=%d, r2=%d, r1=%d\n", SZ_DOUBLE, *(double*)data, *((double*)data+1),*((double*)data+2), *((double*)data+3), *((double*)data+4), outSize, errorBoundMode, absErrBound, relBoundRatio, r5, r4, r3, r2, r1);
