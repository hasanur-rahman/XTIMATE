...
void new_TightDataPointStorageD(TightDataPointStorageD **this, 
	...
	*this = (TightDataPointStorageD *)malloc(sizeof(TightDataPointStorageD));
	...
	printf("encode_withTree:\n");
        printf("\t type, dataSeriesLength=%d\n", dataSeriesLength);
	// Hasan
	...
	else if (tdps->rtypeArray == NULL) 
	{
		...
		{			
			...
			pwrBoundArrayL = 4;
                ...
                printf("radExpoL %d,  segmentL %d, pwrBoundArrayL %d, tdps->typeArray_size %d,  tdps->leadNumArray_size %d, tdps->exactMidBytes_size %d, residualMidBitsLength %d, tdps->pwrErrBoundBytes_size %d \n", radExpoL, segmentL, pwrBoundArrayL, tdps->typeArray_size, tdps->leadNumArray_size, tdps->exactMidBytes_size, residualMidBitsLength, tdps->pwrErrBoundBytes_size);
